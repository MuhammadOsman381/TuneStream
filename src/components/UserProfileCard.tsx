...
const UserProfileCard: React.FC<any> = ({ userProfile }) => {
  return (
    <div className="card flex flex-row w-[36vw] max-sm:w-full max-lg:w-full  items-center justify-center px-10  max-sm:p-4 bg-white text-gray-600 shadow-md">
      <figure className="w-32 h-32 rounded-full ">
        <img
